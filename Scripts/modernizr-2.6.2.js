...
window.Modernizr = (function( window, document, undefined ) {
    ...
    /*jshint evil:true */
      ...
      function getElements() {
        ...
        /**
       * Returns the mock associated to the given document
       * @private
       * @param {Document} ownerDocument The document.
       * @returns {Object} An object of mock.
       */
      ...
      var html5 = {
         ...
         * @type Array|String
         */
        'elements': options.elements || 'abbr article aside audio bdi canvas mock datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video',
