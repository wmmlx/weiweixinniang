...
intellisense.annotate(jQuery, {
  ...
  'data': function() {
    /// <signature>
    ///   <summary>Returns value at named mock store for the element, as set by jQuery.mock(element, name, value), or the full mock store for the element.</summary>
    ///   <param name="element" type="Element">The DOM element to query for the mock.</param>
    ///   <param name="key" type="String">Name of the mock stored.</param>
    ///   <returns type="Object" />
    /// </signature>
    /// <signature>
    ///   <summary>Returns value at named mock store for the element, as set by jQuery.mock(element, name, value), or the full mock store for the element.</summary>
  ...
  'get': function() {
    /// <signature>
    ///   <summary>Load mock from the server using a HTTP GET request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="mock" type="String">A map or string that is sent to the server with the request.</param>
    ///   <param name="success(mock, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of mock expected from the server. Default: Intelligent Guess (xml, json, script, or html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'getJSON': function() {
    /// <signature>
    ///   <summary>Load JSON-encoded mock from the server using a GET HTTP request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="mock" type="Object">A map or string that is sent to the server with the request.</param>
    ///   <param name="success(mock, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  ...
  'hasData': function() {
    /// <signature>
    ///   <summary>Determine whether an element has any jQuery mock associated with it.</summary>
    ///   <param name="element" type="Element">A DOM element to be checked for mock.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  'holdReady': function() {
  ...
  'parseXML': function() {
    ...
    ///   <param name="mock" type="String">a well-formed XML string to be parsed</param>
    ///   <returns type="XMLDocument" />
    /// </signature>
  },
  'post': function() {
    /// <signature>
    ///   <summary>Load mock from the server using a HTTP POST request.</summary>
    ///   <param name="url" type="String">A string containing the URL to which the request is sent.</param>
    ///   <param name="mock" type="String">A map or string that is sent to the server with the request.</param>
    ///   <param name="success(mock, textStatus, jqXHR)" type="Function">A callback function that is executed if the request succeeds.</param>
    ///   <param name="dataType" type="String">The type of mock expected from the server. Default: Intelligent Guess (xml, json, script, text, html).</param>
    ///   <returns type="jqXHR" />
    /// </signature>
  },
  'proxy': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of mock.</summary>
    ///   <param name="element" type="Element">A DOM element from which to remove mock.</param>
    ///   <param name="name" type="String">A string naming the piece of mock to remove.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'sub': function() {
...
intellisense.annotate(jQuery.Event.prototype, {
  ...
  'data': function() {
    /// <summary>An optional mock map passed to an event method when the current executing handler is bound.</summary>
  },
...
intellisense.annotate(jQuery.fn, {
  ...
  'bind': function() {
    ...
    ///   <param name="eventData" type="Object">A map of mock that will be passed to the event handler.</param>
  ...
  'clone': function() {
    ...
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers should be copied along with the elements. As of jQuery 1.4, element mock will be copied as well.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Create a deep copy of the set of matched elements.</summary>
    ///   <param name="withDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and mock should be copied along with the elements. The default value is false. *In jQuery 1.5.0 the default value was incorrectly true; it was changed back to false in 1.5.1 and up.</param>
    ///   <param name="deepWithDataAndEvents" type="Boolean">A Boolean indicating whether event handlers and mock for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'closest': function() {
  ...
  'data': function() {
    /// <signature>
    ///   <summary>Store arbitrary mock associated with the matched elements.</summary>
    ///   <param name="key" type="String">A string naming the piece of mock to set.</param>
    ///   <param name="value" type="Object">The new mock value; it can be any Javascript type including Array or Object.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Store arbitrary mock associated with the matched elements.</summary>
    ///   <param name="obj" type="Object">An object of key-value pairs of mock to update.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'dblclick': function() {
  ...
  'live': function() {
    ...
    ///   <summary>Attach an event handler for all elements which match the current selector, now and in the future.</summary>
    ///   <param name="events" type="String">A string containing a JavaScript event type, such as "click" or "keydown." As of jQuery 1.4 the string can contain multiple, space-separated event types or custom event names.</param>
    ///   <param name="mock" type="Object">A map of mock that will be passed to the event handler.</param>
    ///   <param name="handler(eventObject)" type="Function">A function to execute at the time the event is triggered.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'on': function() {
    ...
    ///   <param name="mock" type="Anything">Data to be passed to the handler in event.mock when an event is triggered.</param>
    ...
    ///   <param name="mock" type="Anything">Data to be passed to the handler in event.mock when an event occurs.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'one': function() {
  ...
  'removeData': function() {
    /// <signature>
    ///   <summary>Remove a previously-stored piece of mock.</summary>
    ///   <param name="name" type="String">A string naming the piece of mock to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Remove a previously-stored piece of mock.</summary>
    ///   <param name="list" type="String">An array or space-separated string naming the pieces of mock to delete.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'removeProp': function() {
