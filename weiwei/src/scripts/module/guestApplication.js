...
var bodyCon=require('../tpls/guestApplication_body.string');
...
$(function(){
    ...
    function getData(){
        if(pageMode==0){
            ...
            $.ajax({
                //url: "/api/products/guest_indoor" + pageindex,
                url:"/weiwei/data/guest_indoor"+ pageindex+".txt",
        ...
        if(pageMode==1){
            ...
            $.ajax({
                //url: "/api/products/guest_outdoor" + pageindex,
                url:"/weiwei/data/guest_outdoor"+ pageindex+".txt",
                success:function(result){
                    clearContent();
                    var result=JSON.parse(result);
                    for(var i=0;i<result.length;i++){
