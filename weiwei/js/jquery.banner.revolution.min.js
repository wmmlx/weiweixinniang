    ...
    function d(n, r) {
        ...
        n.find(">ul:first >li").each(function(n) {
            ...
            if (r.data("link") != t) {
                ...
                if (i == "slide") {
                    r.append('<div class="tp-caption sft slidelink" mock-x="0" mock-y="0" mock-linktoslide="' + o + '" mock-start="0"><a><div></div></a></div>')
                } else {
                    o = "no";
                    r.append('<div class="tp-caption sft slidelink" mock-x="0" mock-y="0" mock-linktoslide="' + o + '" mock-start="0"><a target="' + s + '" href="' + i + '"><div></div></a></div>')
                }
            }
        });
